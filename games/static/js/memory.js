availableImages=["{% static 'images/bean.jpg' %}","{% static 'images/doraemon.jpg' %}","{% static 'images/minion.jpg' %}","{% static 'images/mouse.jpg'%}","{% static 'images/noddy.jpg'%}","{% static 'images/popeye.jpg'%}",
"{% static 'images/scooby.jpg' %}","{% static 'images/shinchan.jpg'%}","{% static 'images/bean.jpg' %}","{% static 'images/doraemon.jpg' %}","{% static 'images/minion.jpg' %}","{% static 'images/mouse.jpg'%}","{% static 'images/noddy.jpg'%}",
"{% static 'images/popeye.jpg'%}","{% static 'images/scooby.jpg' %}","{% static 'images/shinchan.jpg'%}"]
